...
const Male = ({ color, className, percentage }) => {
  ...
  return (
    <div className={className}>
		<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox={size} enableBackground="new 0 0 221.2 500" xmlSpace="preserve">
			<g id="Group_2478" transform="translate(0 0)">
				<g id="Group_2477">
					<path id="Path_2278" fill={color} d="M161.2,61.7c0,27.9-22.6,50.6-50.5,50.6c-27.9,0-50.6-22.6-50.6-50.5
						c0-27.9,22.6-50.6,50.5-50.6l0,0C138.6,11.2,161.2,33.8,161.2,61.7z"/>
					<path id="Path_2279" fill={color} d="M184.4,126.4H37c-8.6,0-15.6,7-15.6,15.6v153.3c-0.1,8.6,6.6,15.8,15.1,16.2
